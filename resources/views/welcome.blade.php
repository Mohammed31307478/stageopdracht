    ...
    <table>
        ...
        @foreach ($todolists as $todolist)
            <tr>
                ...
                <td>{{$todolist->informatie}}<a class="button" href="{{route('todo.edit', $todolist->id)}}">update</a>
                </td>
            </tr>
        @endforeach
...
<section id="section2" class="overmij">
    ...
    <div class="overmijtekst">
        <h1>dromen</h1>
        <p class="text"> mijn dromen zijn ten eerste dat mijn ouders trots op mij zijn. Dat is het belangrijkste. Ten
            tweede
            wil
    ...
    <div class="overmijtekst">
        <h1> overmij </h1>
        <p class="text">
            ik ben Mohammed. ik woon in Hoogeveen.Ik ben 18 jaar oud en ik kom uit Syrie. Ik woon nu vijf
            jaar in Nederland.
    ...
    <div class="overmijtekst">
        ...
        <p class="text">
            ...
            dat ik mijn kennis kan laten zien . Ik hoop dat de website voldoet aan jullie eisen.
            En ik hoop dat ik uitgenodigd wordt voor kennis maak gesprek. Als jij,
